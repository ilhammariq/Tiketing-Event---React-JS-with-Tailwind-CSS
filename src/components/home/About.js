            ...
            <div className="bg-gray-800 p-12">
                <div className="grid grid-cols-3">
                    <div className="flex flex-col space-y-4 items-center justify-center">
                        <img className='bg-white rounded-full w-28 h-28' src={Logo} alt="" />
                        <div className="flex flex-row space-x-6 text-white">
                            <a href='/' className="border-2 p-3 rounded-lg hover:text-black hover:border-black">
                            ...
                            <a href='/' className="border-2 rounded-lg p-3 hover:text-black hover:border-black">
